...
static const Key keys[] = {
    ...
    // { MODKEY,             XK_n,          spawn,      SHCMD("neovide +ObsidianSearch") },
    // { MODKEY | ShiftMask, XK_n,          spawn,      SHCMD("neovide +ObsidianNew") },
    ...
    // { MODKEY | ShiftMask, XK_n,          spawn,     {.v = (const char*[]) { TERMINAL, "-e", "nvim", "+ObsidianNew",      NULL } } },
